...
namespace StoreOnline.Controllers
{
    public class UserController : Controller
    {
        ...
        dbshoponlineEntities1 db = new dbshoponlineEntities1();
        ...
        public ActionResult Ads(int? id, int? page)
        {
            int pagesize = 9, pageindex = 1;
            pageindex = page.HasValue ? Convert.ToInt32(page) : 1;
            var list = db.tbl_product.Where(x => x.pro_fk_ad == id).OrderByDescending(x => x.pro_id).ToList();
        ...
        public ActionResult ViewAd(int? id)
        {
            ...
            tbl_category cat = db.tbl_category.Where(x => x.cat_id == p.pro_fk_ad).SingleOrDefault();
